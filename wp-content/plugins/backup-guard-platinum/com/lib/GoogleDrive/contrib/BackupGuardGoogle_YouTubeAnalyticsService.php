 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $youtubeAnalyticsService = new BackupGuardGoogle_YouTubeAnalyticsService(...);
  ...
  class BackupGuardGoogle_ReportsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @return BackupGuardGoogle_ResultTable
     */
    public function query($ids, $start_date, $end_date, $metrics, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_ResultTable($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for BackupGuardGoogle_YouTubeAnalytics (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class BackupGuardGoogle_YouTubeAnalyticsService extends BackupGuardGoogle_Service {
  public $reports;
  /**
...
class BackupGuardGoogle_ResultTable extends BackupGuardGoogle_Model {
  protected $__columnHeadersType = 'BackupGuardGoogle_ResultTableColumnHeaders';
  protected $__columnHeadersDataType = 'array';
  public $columnHeaders;
  public $kind;
  public $rows;
  public function setColumnHeaders(/* array(BackupGuardGoogle_ResultTableColumnHeaders) */ $columnHeaders) {
    $this->assertIsArray($columnHeaders, 'BackupGuardGoogle_ResultTableColumnHeaders', __METHOD__);
...
class BackupGuardGoogle_ResultTableColumnHeaders extends BackupGuardGoogle_Model {
  public $columnType;
  public $dataType;
  public $name;
