 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $orkutService = new BackupGuardGoogle_OrkutService(...);
   *   $acl = $orkutService->acl;
   *  </code>
   */
  class BackupGuardGoogle_AclServiceResource extends BackupGuardGoogle_ServiceResource {
  ...
  class BackupGuardGoogle_ActivitiesServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @return BackupGuardGoogle_ActivityList
     */
    public function listActivities($userId, $collection, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_ActivityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_ActivityVisibilityServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Visibility
     */
    public function get($activityId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Visibility($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param string $activityId ID of the activity.
     * @param BackupGuardGoogle_Visibility $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Visibility
     */
    public function patch($activityId, BackupGuardGoogle_Visibility $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_Visibility
     */
    public function update($activityId, BackupGuardGoogle_Visibility $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class BackupGuardGoogle_BadgesServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Badge
     */
    public function get($userId, $badgeId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Badge($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $userId The id of the user whose badges will be listed. Can be me to refer to caller.
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_BadgeList
     */
    public function listBadges($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_BadgeList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommentsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return BackupGuardGoogle_Comment
     */
    public function get($commentId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Comment($data);
      } else {
        return $data;
      }
    }
     ...
     * @param BackupGuardGoogle_Comment $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Comment
     */
    public function insert($activityId, BackupGuardGoogle_Comment $postBody, $optParams = array()) {
      $params = array('activityId' => $activityId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
     ...
     * @opt_param string pageToken A continuation token that allows pagination.
     * @return BackupGuardGoogle_CommentList
     */
    public function listComments($activityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunitiesServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return BackupGuardGoogle_Community
     */
    public function get($communityId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Community($data);
      } else {
        return $data;
      }
    }
     ...
     * @return BackupGuardGoogle_CommunityList
     */
    public function listCommunities($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityFollowServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param string $userId ID of the user.
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_CommunityMembers
     */
    public function insert($communityId, $userId, $optParams = array()) {
      ...
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityMembers($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityMembersServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @opt_param string pageToken A continuation token that allows pagination.
     * @return BackupGuardGoogle_CommunityMembersList
     */
    public function listCommunityMembers($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityMembersList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityMessagesServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param BackupGuardGoogle_CommunityMessage $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_CommunityMessage
     */
    public function insert($communityId, $topicId, BackupGuardGoogle_CommunityMessage $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'topicId' => $topicId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityMessage($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken A continuation token that allows pagination.
     * @return BackupGuardGoogle_CommunityMessageList
     */
    public function listCommunityMessages($communityId, $topicId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityMessageList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityPollCommentsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param BackupGuardGoogle_CommunityPollComment $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_CommunityPollComment
     */
    public function insert($communityId, $pollId, BackupGuardGoogle_CommunityPollComment $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityPollComment($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken A continuation token that allows pagination.
     * @return BackupGuardGoogle_CommunityPollCommentList
     */
    public function listCommunityPollComments($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityPollCommentList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityPollVotesServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param BackupGuardGoogle_CommunityPollVote $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_CommunityPollVote
     */
    public function insert($communityId, $pollId, BackupGuardGoogle_CommunityPollVote $postBody, $optParams = array()) {
      $params = array('communityId' => $communityId, 'pollId' => $pollId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityPollVote($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityPollsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return BackupGuardGoogle_CommunityPoll
     */
    public function get($communityId, $pollId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityPoll($data);
      } else {
        return $data;
      }
    }
     ...
     * @opt_param string pageToken A continuation token that allows pagination.
     * @return BackupGuardGoogle_CommunityPollList
     */
    public function listCommunityPolls($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityPollList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityRelatedServiceResource extends BackupGuardGoogle_ServiceResource {
   ...
   *  </code>
   */
  class BackupGuardGoogle_CommunityTopicsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     *
     * @opt_param string hl Specifies the interface language (host language) of your user interface.
     * @return BackupGuardGoogle_CommunityTopic
     */
    public function get($communityId, $topicId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityTopic($data);
      } else {
        return $data;
      }
    }
     ...
     * @param BackupGuardGoogle_CommunityTopic $postBody
     * @param array $optParams Optional parameters.
     *
     * @opt_param bool isShout Whether this topic is a shout.
     * @return BackupGuardGoogle_CommunityTopic
     */
    public function insert($communityId, BackupGuardGoogle_CommunityTopic $postBody, $optParams = array()) {
     ...
     * @opt_param string pageToken A continuation token that allows pagination.
     * @return BackupGuardGoogle_CommunityTopicList
     */
    public function listCommunityTopics($communityId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CommunityTopicList($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_CountersServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Counters
     */
    public function listCounters($userId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Counters($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_ScrapsServiceResource extends BackupGuardGoogle_ServiceResource {

    /**
     * Creates a new scrap. (scraps.insert)
     *
     * @param BackupGuardGoogle_Activity $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Activity
     */
    public function insert(BackupGuardGoogle_Activity $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Activity($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for BackupGuardGoogle_Orkut (v2).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class BackupGuardGoogle_OrkutService extends BackupGuardGoogle_Service {
  public $acl;
  public $activities;
...
class BackupGuardGoogle_Acl extends BackupGuardGoogle_Model {
  public $description;
  protected $__itemsType = 'BackupGuardGoogle_AclItems';
  ...
  public function setItems(/* array(BackupGuardGoogle_AclItems) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_AclItems', __METHOD__);
    $this->items = $items;
  }
...
class BackupGuardGoogle_AclItems extends BackupGuardGoogle_Model {
  public $id;
  public $type;
...
class BackupGuardGoogle_Activity extends BackupGuardGoogle_Model {
  protected $__accessType = 'BackupGuardGoogle_Acl';
  protected $__accessDataType = '';
  public $access;
  protected $__actorType = 'BackupGuardGoogle_OrkutAuthorResource';
  protected $__actorDataType = '';
  public $actor;
  public $id;
  public $kind;
  protected $__linksType = 'BackupGuardGoogle_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
  protected $__objectType = 'BackupGuardGoogle_ActivityObject';
  ...
  public $updated;
  public $verb;
  public function setAccess(BackupGuardGoogle_Acl $access) {
    $this->access = $access;
  }
  public function getAccess() {
    return $this->access;
  }
  public function setActor(BackupGuardGoogle_OrkutAuthorResource $actor) {
    $this->actor = $actor;
  }
  ...
  public function setLinks(/* array(BackupGuardGoogle_OrkutLinkResource) */ $links) {
    $this->assertIsArray($links, 'BackupGuardGoogle_OrkutLinkResource', __METHOD__);
    $this->links = $links;
  }
  public function getLinks() {
    return $this->links;
  }
  public function setObject(BackupGuardGoogle_ActivityObject $object) {
    $this->object = $object;
  }
...
class BackupGuardGoogle_ActivityList extends BackupGuardGoogle_Model {
...
class BackupGuardGoogle_ActivityObject extends BackupGuardGoogle_Model {
  public $content;
  protected $__itemsType = 'BackupGuardGoogle_OrkutActivityobjectsResource';
  protected $__itemsDataType = 'array';
  public $items;
  public $objectType;
  protected $__repliesType = 'BackupGuardGoogle_ActivityObjectReplies';
  ...
  public function setItems(/* array(BackupGuardGoogle_OrkutActivityobjectsResource) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_OrkutActivityobjectsResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  ...
  public function setReplies(BackupGuardGoogle_ActivityObjectReplies $replies) {
...
class BackupGuardGoogle_ActivityObjectReplies extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Comment';
  protected $__itemsDataType = 'array';
  public $items;
  public $totalItems;
  public $url;
  public function setItems(/* array(BackupGuardGoogle_Comment) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Comment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_Badge extends BackupGuardGoogle_Model {
...
class BackupGuardGoogle_BadgeList extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Badge';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_Badge) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Badge', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_Comment extends BackupGuardGoogle_Model {
  protected $__actorType = 'BackupGuardGoogle_OrkutAuthorResource';
  protected $__actorDataType = '';
  public $actor;
  public $content;
  public $id;
  protected $__inReplyToType = 'BackupGuardGoogle_CommentInReplyTo';
  ...
  public function setInReplyTo(BackupGuardGoogle_CommentInReplyTo $inReplyTo) {
...
class BackupGuardGoogle_CommentInReplyTo extends BackupGuardGoogle_Model {
  public $href;
  public $ref;
  public $rel;
  public $type;
...
class BackupGuardGoogle_CommentList extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Comment';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
...
class BackupGuardGoogle_Community extends BackupGuardGoogle_Model {
  public $category;
  protected $__co_ownersType = 'BackupGuardGoogle_OrkutAuthorResource';
  ...
  public $location;
  public $member_count;
  protected $__moderatorsType = 'BackupGuardGoogle_OrkutAuthorResource';
  protected $__moderatorsDataType = 'array';
  public $moderators;
  public $name;
  protected $__ownerType = 'BackupGuardGoogle_OrkutAuthorResource';
  ...
  public function setCo_owners(/* array(BackupGuardGoogle_OrkutAuthorResource) */ $co_owners) {
    $this->assertIsArray($co_owners, 'BackupGuardGoogle_OrkutAuthorResource', __METHOD__);
  ...
  public function setModerators(/* array(BackupGuardGoogle_OrkutAuthorResource) */ $moderators) {
    $this->assertIsArray($moderators, 'BackupGuardGoogle_OrkutAuthorResource', __METHOD__);
  ...
  public function setOwner(BackupGuardGoogle_OrkutAuthorResource $owner) {
    $this->owner = $owner;
  }
...
class BackupGuardGoogle_CommunityList extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Community';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_Community) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Community', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_CommunityMembers extends BackupGuardGoogle_Model {
  protected $__communityMembershipStatusType = 'BackupGuardGoogle_CommunityMembershipStatus';
  protected $__communityMembershipStatusDataType = '';
  public $communityMembershipStatus;
  public $kind;
  protected $__personType = 'BackupGuardGoogle_OrkutActivitypersonResource';
  protected $__personDataType = '';
  public $person;
  public function setCommunityMembershipStatus(BackupGuardGoogle_CommunityMembershipStatus $communityMembershipStatus) {
  ...
  public function setPerson(BackupGuardGoogle_OrkutActivitypersonResource $person) {
    $this->person = $person;
  }
...
class BackupGuardGoogle_CommunityMembersList extends BackupGuardGoogle_Model {
  public $firstPageToken;
  protected $__itemsType = 'BackupGuardGoogle_CommunityMembers';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  ...
  public function setItems(/* array(BackupGuardGoogle_CommunityMembers) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_CommunityMembers', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_CommunityMembershipStatus extends BackupGuardGoogle_Model {
...
class BackupGuardGoogle_CommunityMessage extends BackupGuardGoogle_Model {
  public $addedDate;
  protected $__authorType = 'BackupGuardGoogle_OrkutAuthorResource';
  ...
  public function setAuthor(BackupGuardGoogle_OrkutAuthorResource $author) {
    $this->author = $author;
  }
...
class BackupGuardGoogle_CommunityMessageList extends BackupGuardGoogle_Model {
  public $firstPageToken;
  protected $__itemsType = 'BackupGuardGoogle_CommunityMessage';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $lastPageToken;
  ...
  public function setItems(/* array(BackupGuardGoogle_CommunityMessage) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_CommunityMessage', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_CommunityPoll extends BackupGuardGoogle_Model {
  protected $__authorType = 'BackupGuardGoogle_OrkutAuthorResource';
  protected $__authorDataType = '';
  public $author;
  public $communityId;
  ...
  public $hasVoted;
  public $id;
  protected $__imageType = 'BackupGuardGoogle_CommunityPollImage';
  ...
  protected $__linksDataType = 'array';
  public $links;
  protected $__optionsType = 'BackupGuardGoogle_OrkutCommunitypolloptionResource';
  ...
  public function setImage(BackupGuardGoogle_CommunityPollImage $image) {
    $this->image = $image;
  }
  ...
  public function setOptions(/* array(BackupGuardGoogle_OrkutCommunitypolloptionResource) */ $options) {
    $this->assertIsArray($options, 'BackupGuardGoogle_OrkutCommunitypolloptionResource', __METHOD__);
  ...
  public function setVotedOptions(/* array(BackupGuardGoogle_int) */ $votedOptions) {
    $this->assertIsArray($votedOptions, 'BackupGuardGoogle_int', __METHOD__);
...
class BackupGuardGoogle_CommunityPollComment extends BackupGuardGoogle_Model {
  public $addedDate;
  protected $__authorType = 'BackupGuardGoogle_OrkutAuthorResource';
  protected $__authorDataType = '';
  public $author;
...
class BackupGuardGoogle_CommunityPollCommentList extends BackupGuardGoogle_Model {
  public $firstPageToken;
  protected $__itemsType = 'BackupGuardGoogle_CommunityPollComment';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $lastPageToken;
  ...
  public function setItems(/* array(BackupGuardGoogle_CommunityPollComment) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_CommunityPollComment', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_CommunityPollImage extends BackupGuardGoogle_Model {
  public $url;
  public function setUrl( $url) {
    $this->url = $url;
  }
...
class BackupGuardGoogle_CommunityPollList extends BackupGuardGoogle_Model {
  public $firstPageToken;
  protected $__itemsType = 'BackupGuardGoogle_CommunityPoll';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $lastPageToken;
  ...
  public function setItems(/* array(BackupGuardGoogle_CommunityPoll) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_CommunityPoll', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_CommunityPollVote extends BackupGuardGoogle_Model {
  ...
  public function setOptionIds(/* array(BackupGuardGoogle_int) */ $optionIds) {
    $this->assertIsArray($optionIds, 'BackupGuardGoogle_int', __METHOD__);
...
class BackupGuardGoogle_CommunityTopic extends BackupGuardGoogle_Model {
  protected $__authorType = 'BackupGuardGoogle_OrkutAuthorResource';
  protected $__authorDataType = '';
  public $author;
  public $body;
  ...
  protected $__linksDataType = 'array';
  public $links;
  protected $__messagesType = 'BackupGuardGoogle_CommunityMessage';
  ...
  public function setMessages(/* array(BackupGuardGoogle_CommunityMessage) */ $messages) {
    $this->assertIsArray($messages, 'BackupGuardGoogle_CommunityMessage', __METHOD__);
...
class BackupGuardGoogle_CommunityTopicList extends BackupGuardGoogle_Model {
  public $firstPageToken;
  protected $__itemsType = 'BackupGuardGoogle_CommunityTopic';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $lastPageToken;
  ...
  public function setItems(/* array(BackupGuardGoogle_CommunityTopic) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_CommunityTopic', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_Counters extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_OrkutCounterResource';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_OrkutCounterResource) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_OrkutCounterResource', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_OrkutActivityobjectsResource extends BackupGuardGoogle_Model {
  protected $__communityType = 'BackupGuardGoogle_Community';
  ...
  protected $__personDataType = '';
  public $person;
  public function setCommunity(BackupGuardGoogle_Community $community) {
...
class BackupGuardGoogle_OrkutActivitypersonResource extends BackupGuardGoogle_Model {
  public $birthday;
  public $gender;
  public $id;
  protected $__imageType = 'BackupGuardGoogle_OrkutActivitypersonResourceImage';
  protected $__imageDataType = '';
  public $image;
  protected $__nameType = 'BackupGuardGoogle_OrkutActivitypersonResourceName';
  ...
  public function setImage(BackupGuardGoogle_OrkutActivitypersonResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
  }
  public function setName(BackupGuardGoogle_OrkutActivitypersonResourceName $name) {
    $this->name = $name;
  }
  public function getName() {
    return $this->name;
...
class BackupGuardGoogle_OrkutActivitypersonResourceImage extends BackupGuardGoogle_Model {
  public $url;
  public function setUrl( $url) {
    $this->url = $url;
  }
...
class BackupGuardGoogle_OrkutActivitypersonResourceName extends BackupGuardGoogle_Model {
  public $familyName;
  public $givenName;
...
class BackupGuardGoogle_OrkutAuthorResource extends BackupGuardGoogle_Model {
  public $displayName;
  public $id;
  protected $__imageType = 'BackupGuardGoogle_OrkutAuthorResourceImage';
  protected $__imageDataType = '';
  public $image;
  public $url;
  public function setDisplayName( $displayName) {
  ...
  public function setImage(BackupGuardGoogle_OrkutAuthorResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class BackupGuardGoogle_OrkutAuthorResourceImage extends BackupGuardGoogle_Model {
  public $url;
  public function setUrl( $url) {
    $this->url = $url;
  }
...
class BackupGuardGoogle_OrkutCommunitypolloptionResource extends BackupGuardGoogle_Model {
  public $description;
  protected $__imageType = 'BackupGuardGoogle_OrkutCommunitypolloptionResourceImage';
  protected $__imageDataType = '';
  public $image;
  ...
  public function setImage(BackupGuardGoogle_OrkutCommunitypolloptionResourceImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
...
class BackupGuardGoogle_OrkutCommunitypolloptionResourceImage extends BackupGuardGoogle_Model {
  public $url;
  public function setUrl( $url) {
    $this->url = $url;
  }
...
class BackupGuardGoogle_OrkutCounterResource extends BackupGuardGoogle_Model {
  protected $__linkType = 'BackupGuardGoogle_OrkutLinkResource';
  protected $__linkDataType = '';
  public $link;
  public $name;
  public $total;
  public function setLink(BackupGuardGoogle_OrkutLinkResource $link) {
    $this->link = $link;
  }
...
class BackupGuardGoogle_OrkutLinkResource extends BackupGuardGoogle_Model {
  public $href;
  public $rel;
  public $title;
  public $type;
...
class BackupGuardGoogle_Visibility extends BackupGuardGoogle_Model {
  public $kind;
  protected $__linksType = 'BackupGuardGoogle_OrkutLinkResource';
  protected $__linksDataType = 'array';
  public $links;
