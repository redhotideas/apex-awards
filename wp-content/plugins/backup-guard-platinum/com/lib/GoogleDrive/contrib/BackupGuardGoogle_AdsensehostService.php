 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $adsensehostService = new BackupGuardGoogle_AdSenseHostService(...);
  ...
  class BackupGuardGoogle_AccountsAdclientsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_AdClient
     */
    public function get($accountId, $adClientId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_AdClient($data);
      } else {
        return $data;
      }
    }
  ...
  class BackupGuardGoogle_AccountsAdunitsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param BackupGuardGoogle_AdUnit $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_AdUnit
     */
    public function insert($accountId, $adClientId, BackupGuardGoogle_AdUnit $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_AdUnit
     */
    public function patch($accountId, $adClientId, $adUnitId, BackupGuardGoogle_AdUnit $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_AdUnit
     */
    public function update($accountId, $adClientId, BackupGuardGoogle_AdUnit $postBody, $optParams = array()) {
      $params = array('accountId' => $accountId, 'adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class BackupGuardGoogle_AssociationsessionsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @return BackupGuardGoogle_AssociationSession
     */
    public function start($productCode, $websiteUrl, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_AssociationSession($data);
      } else {
        return $data;
      }
    }
  ...
  class BackupGuardGoogle_CustomchannelsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param BackupGuardGoogle_CustomChannel $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_CustomChannel
     */
    public function insert($adClientId, BackupGuardGoogle_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_CustomChannel
     */
    public function patch($adClientId, $customChannelId, BackupGuardGoogle_CustomChannel $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_CustomChannel
     */
    public function update($adClientId, BackupGuardGoogle_CustomChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
  ...
  class BackupGuardGoogle_UrlchannelsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_UrlChannel
     */
    public function delete($adClientId, $urlChannelId, $optParams = array()) {
      ...
      $data = $this->__call('delete', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_UrlChannel($data);
      } else {
        return $data;
      }
    }
     ...
     * @param BackupGuardGoogle_UrlChannel $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_UrlChannel
     */
    public function insert($adClientId, BackupGuardGoogle_UrlChannel $postBody, $optParams = array()) {
      $params = array('adClientId' => $adClientId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
...
/**
 * Service definition for BackupGuardGoogle_AdSenseHost (v4.1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class BackupGuardGoogle_AdSenseHostService extends BackupGuardGoogle_Service {
  public $accounts;
...
class BackupGuardGoogle_AssociationSession extends BackupGuardGoogle_Model {
  public $accountId;
  public $id;
  public $kind;
  public $productCodes;
  ...
  public function setProductCodes(/* array(BackupGuardGoogle_string) */ $productCodes) {
    $this->assertIsArray($productCodes, 'BackupGuardGoogle_string', __METHOD__);
