 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $coordinateService = new BackupGuardGoogle_CoordinateService(...);
   *   $customFieldDef = $coordinateService->customFieldDef;
   *  </code>
   */
  class BackupGuardGoogle_CustomFieldDefServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @return BackupGuardGoogle_CustomFieldDefListResponse
     */
    public function listCustomFieldDef($teamId, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_CustomFieldDefListResponse($data);
      } else {
        return $data;
      }
    }
  ...
  class BackupGuardGoogle_JobsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @return BackupGuardGoogle_Job
     */
    public function insert($teamId, $address, $lat, $lng, $title, BackupGuardGoogle_Job $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_JobListResponse
     */
    public function listJobs($teamId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_JobListResponse($data);
      } else {
        return $data;
      }
    }
     ...
     * @return BackupGuardGoogle_Job
     */
    public function patch($teamId, $jobId, BackupGuardGoogle_Job $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_Job
     */
    public function update($teamId, $jobId, BackupGuardGoogle_Job $postBody, $optParams = array()) {
      $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class BackupGuardGoogle_LocationServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @opt_param string maxResults Maximum number of results to return in one page.
     * @opt_param string pageToken Continuation token
     * @return BackupGuardGoogle_LocationListResponse
     */
    public function listLocation($teamId, $workerEmail, $startTimestampMs, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_LocationListResponse($data);
      } else {
        return $data;
      }
    }
   ...
   *  </code>
   */
  class BackupGuardGoogle_ScheduleServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param string $jobId Job number
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Schedule
     */
    public function get($teamId, $jobId, $optParams = array()) {
      $params = array('teamId' => $teamId, 'jobId' => $jobId);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Schedule($data);
      } else {
        return $data;
      }
    }
     ...
     * @param string $teamId Team ID
     * @param string $jobId Job number
     * @param BackupGuardGoogle_Schedule $postBody
     * @param array $optParams Optional parameters.
     *
     ...
     * @return BackupGuardGoogle_Schedule
     */
    public function patch($teamId, $jobId, BackupGuardGoogle_Schedule $postBody, $optParams = array()) {
      $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
     ...
     * @return BackupGuardGoogle_Schedule
     */
    public function update($teamId, $jobId, BackupGuardGoogle_Schedule $postBody, $optParams = array()) {
      $params = array('teamId' => $teamId, 'jobId' => $jobId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class BackupGuardGoogle_WorkerServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param string $teamId Team ID
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_WorkerListResponse
     */
    public function listWorker($teamId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_WorkerListResponse($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for BackupGuardGoogle_Coordinate (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class BackupGuardGoogle_CoordinateService extends BackupGuardGoogle_Service {
  ...
  public function __construct(BackupGuardGoogle_Client $client) {
    ...
    $this->customFieldDef = new BackupGuardGoogle_CustomFieldDefServiceResource($this, $this->serviceName, 'customFieldDef', json_decode('{"methods": {"list": {"id": "coordinate.customFieldDef.list", "path": "{teamId}/custom_fields", "httpMethod": "GET", "parameters": {"teamId": {"type": "string", "required": true, "location": "path"}}, "response": {"$ref": "CustomFieldDefListResponse"}, "scopes": ["https://www.googleapis.com/auth/coordinate", "https://www.googleapis.com/auth/coordinate.readonly"]}}}', true));
...
class BackupGuardGoogle_CustomField extends BackupGuardGoogle_Model {
...
class BackupGuardGoogle_CustomFieldDef extends BackupGuardGoogle_Model {
  public $enabled;
  public $id;
  public $kind;
  public $name;
...
class BackupGuardGoogle_CustomFieldDefListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_CustomFieldDef';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_CustomFieldDef) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_CustomFieldDef', __METHOD__);
    $this->items = $items;
  }
...
class BackupGuardGoogle_CustomFields extends BackupGuardGoogle_Model {
  protected $__customFieldType = 'BackupGuardGoogle_CustomField';
  protected $__customFieldDataType = 'array';
  public $customField;
  public $kind;
  public function setCustomField(/* array(BackupGuardGoogle_CustomField) */ $customField) {
    $this->assertIsArray($customField, 'BackupGuardGoogle_CustomField', __METHOD__);
...
class BackupGuardGoogle_Job extends BackupGuardGoogle_Model {
  public $id;
  protected $__jobChangeType = 'BackupGuardGoogle_JobChange';
  protected $__jobChangeDataType = 'array';
  public $jobChange;
  public $kind;
  protected $__stateType = 'BackupGuardGoogle_JobState';
  ...
  public function setJobChange(/* array(BackupGuardGoogle_JobChange) */ $jobChange) {
    $this->assertIsArray($jobChange, 'BackupGuardGoogle_JobChange', __METHOD__);
  ...
  public function setState(BackupGuardGoogle_JobState $state) {
    $this->state = $state;
  }
...
class BackupGuardGoogle_JobChange extends BackupGuardGoogle_Model {
  public $kind;
  protected $__stateType = 'BackupGuardGoogle_JobState';
  protected $__stateDataType = '';
  public $state;
...
class BackupGuardGoogle_JobListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Job';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(BackupGuardGoogle_Job) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Job', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_JobState extends BackupGuardGoogle_Model {
  public $assignee;
  protected $__customFieldsType = 'BackupGuardGoogle_CustomFields';
  ...
  public function setCustomFields(BackupGuardGoogle_CustomFields $customFields) {
  ...
  public function setNote(/* array(BackupGuardGoogle_string) */ $note) {
    $this->assertIsArray($note, 'BackupGuardGoogle_string', __METHOD__);
    $this->note = $note;
  }
...
class BackupGuardGoogle_Location extends BackupGuardGoogle_Model {
  ...
  public $lat;
  public $lng;
  public function setAddressLine(/* array(BackupGuardGoogle_string) */ $addressLine) {
    $this->assertIsArray($addressLine, 'BackupGuardGoogle_string', __METHOD__);
...
class BackupGuardGoogle_LocationListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_LocationRecord';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  protected $__tokenPaginationType = 'BackupGuardGoogle_TokenPagination';
  protected $__tokenPaginationDataType = '';
  public $tokenPagination;
  public function setItems(/* array(BackupGuardGoogle_LocationRecord) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_LocationRecord', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
  ...
  public function setTokenPagination(BackupGuardGoogle_TokenPagination $tokenPagination) {
...
class BackupGuardGoogle_LocationRecord extends BackupGuardGoogle_Model {
...
class BackupGuardGoogle_Schedule extends BackupGuardGoogle_Model {
  public $allDay;
  public $duration;
  public $endTime;
  public $kind;
...
class BackupGuardGoogle_TokenPagination extends BackupGuardGoogle_Model {
  public $kind;
  public $nextPageToken;
...
class BackupGuardGoogle_Worker extends BackupGuardGoogle_Model {
  public $id;
  public $kind;
  public function setId( $id) {
    $this->id = $id;
...
class BackupGuardGoogle_WorkerListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Worker';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_Worker) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Worker', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
