 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $customsearchService = new BackupGuardGoogle_CustomsearchService(...);
   *   $cse = $customsearchService->cse;
   *  </code>
   */
  class BackupGuardGoogle_CseServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @return BackupGuardGoogle_Search
     */
    public function listCse($q, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Search($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for BackupGuardGoogle_Customsearch (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class BackupGuardGoogle_CustomsearchService extends BackupGuardGoogle_Service {
  public $cse;
  /**
...
class BackupGuardGoogle_Context extends BackupGuardGoogle_Model {
  protected $__facetsType = 'BackupGuardGoogle_ContextFacets';
  protected $__facetsDataType = 'array';
  public $facets;
  public $title;
  public function setFacets(/* array(BackupGuardGoogle_ContextFacets) */ $facets) {
    $this->assertIsArray($facets, 'BackupGuardGoogle_ContextFacets', __METHOD__);
    $this->facets = $facets;
  }
...
class BackupGuardGoogle_ContextFacets extends BackupGuardGoogle_Model {
  public $anchor;
  public $label;
...
class BackupGuardGoogle_Promotion extends BackupGuardGoogle_Model {
  protected $__bodyLinesType = 'BackupGuardGoogle_PromotionBodyLines';
  protected $__bodyLinesDataType = 'array';
  public $bodyLines;
  public $displayLink;
  public $htmlTitle;
  protected $__imageType = 'BackupGuardGoogle_PromotionImage';
  protected $__imageDataType = '';
  public $image;
  public $link;
  public $title;
  public function setBodyLines(/* array(BackupGuardGoogle_PromotionBodyLines) */ $bodyLines) {
    $this->assertIsArray($bodyLines, 'BackupGuardGoogle_PromotionBodyLines', __METHOD__);
  ...
  public function setImage(BackupGuardGoogle_PromotionImage $image) {
    $this->image = $image;
  }
...
class BackupGuardGoogle_PromotionBodyLines extends BackupGuardGoogle_Model {
  public $htmlTitle;
  public $link;
  public $title;
  public $url;
...
class BackupGuardGoogle_PromotionImage extends BackupGuardGoogle_Model {
  public $height;
  public $source;
  public $width;
...
class BackupGuardGoogle_Result extends BackupGuardGoogle_Model {
  ...
  public $htmlSnippet;
  public $htmlTitle;
  protected $__imageType = 'BackupGuardGoogle_ResultImage';
  protected $__imageDataType = '';
  public $image;
  public $kind;
  protected $__labelsType = 'BackupGuardGoogle_ResultLabels';
  ...
  public function setImage(BackupGuardGoogle_ResultImage $image) {
    $this->image = $image;
  }
  public function getImage() {
    return $this->image;
  ...
  public function setLabels(/* array(BackupGuardGoogle_ResultLabels) */ $labels) {
    $this->assertIsArray($labels, 'BackupGuardGoogle_ResultLabels', __METHOD__);
    $this->labels = $labels;
  }
...
class BackupGuardGoogle_ResultImage extends BackupGuardGoogle_Model {
  public $byteSize;
  public $contextLink;
  public $height;
...
class BackupGuardGoogle_ResultLabels extends BackupGuardGoogle_Model {
  public $displayName;
  public $name;
...
class BackupGuardGoogle_Search extends BackupGuardGoogle_Model {
  protected $__contextType = 'BackupGuardGoogle_Context';
  protected $__contextDataType = '';
  public $context;
  protected $__itemsType = 'BackupGuardGoogle_Result';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  protected $__promotionsType = 'BackupGuardGoogle_Promotion';
  protected $__promotionsDataType = 'array';
  public $promotions;
  protected $__queriesType = 'BackupGuardGoogle_Query';
  protected $__queriesDataType = 'map';
  public $queries;
  protected $__searchInformationType = 'BackupGuardGoogle_SearchSearchInformation';
  protected $__searchInformationDataType = '';
  public $searchInformation;
  protected $__spellingType = 'BackupGuardGoogle_SearchSpelling';
  protected $__spellingDataType = '';
  public $spelling;
  protected $__urlType = 'BackupGuardGoogle_SearchUrl';
  protected $__urlDataType = '';
  public $url;
  public function setContext(BackupGuardGoogle_Context $context) {
    $this->context = $context;
  }
  public function getContext() {
    return $this->context;
  }
  public function setItems(/* array(BackupGuardGoogle_Result) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Result', __METHOD__);
    $this->items = $items;
  }
  ...
  public function setPromotions(/* array(BackupGuardGoogle_Promotion) */ $promotions) {
    $this->assertIsArray($promotions, 'BackupGuardGoogle_Promotion', __METHOD__);
    $this->promotions = $promotions;
  }
  public function getPromotions() {
    return $this->promotions;
  }
  public function setQueries(BackupGuardGoogle_Query $queries) {
    $this->queries = $queries;
  }
  public function getQueries() {
    return $this->queries;
  }
  public function setSearchInformation(BackupGuardGoogle_SearchSearchInformation $searchInformation) {
    $this->searchInformation = $searchInformation;
  }
  public function getSearchInformation() {
    return $this->searchInformation;
  }
  public function setSpelling(BackupGuardGoogle_SearchSpelling $spelling) {
    $this->spelling = $spelling;
  }
  public function getSpelling() {
    return $this->spelling;
  }
  public function setUrl(BackupGuardGoogle_SearchUrl $url) {
    $this->url = $url;
  }
  public function getUrl() {
    return $this->url;
...
class BackupGuardGoogle_SearchSearchInformation extends BackupGuardGoogle_Model {
...
class BackupGuardGoogle_SearchSpelling extends BackupGuardGoogle_Model {
...
class BackupGuardGoogle_SearchUrl extends BackupGuardGoogle_Model {
  public $template;
  public $type;
