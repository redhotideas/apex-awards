 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $mirrorService = new BackupGuardGoogle_MirrorService(...);
   *   $contacts = $mirrorService->contacts;
   *  </code>
   */
  class BackupGuardGoogle_ContactsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param string $id The ID of the contact.
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Contact
     */
    public function get($id, $optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Contact($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param BackupGuardGoogle_Contact $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Contact
     */
    public function insert(BackupGuardGoogle_Contact $postBody, $optParams = array()) {
     ...
     *
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_ContactsListResponse
     */
    public function listContacts($optParams = array()) {
      ...
      if ($this->useObjects()) {
        return new BackupGuardGoogle_ContactsListResponse($data);
      } else {
        return $data;
      }
    }
     ...
     * @return BackupGuardGoogle_Contact
     */
    public function patch($id, BackupGuardGoogle_Contact $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_Contact
     */
    public function update($id, BackupGuardGoogle_Contact $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
   ...
   *  </code>
   */
  class BackupGuardGoogle_LocationsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Location
     */
    public function get($id, $optParams = array()) {
      $params = array('id' => $id);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Location($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_LocationsListResponse
     */
    public function listLocations($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_LocationsListResponse($data);
      } else {
        return $data;
      }
    }
  ...
  class BackupGuardGoogle_SubscriptionsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     */
    public function insert(BackupGuardGoogle_Subscription $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     *
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_SubscriptionsListResponse
     */
    public function listSubscriptions($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_SubscriptionsListResponse($data);
      } else {
        return $data;
      }
    }
     ...
     * @return BackupGuardGoogle_Subscription
     */
    public function update($id, BackupGuardGoogle_Subscription $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class BackupGuardGoogle_TimelineServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param string $id The ID of the timeline item.
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_TimelineItem
     */
    public function get($id, $optParams = array()) {
      $params = array('id' => $id);
      $params = array_merge($params, $optParams);
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_TimelineItem($data);
      } else {
        return $data;
      }
    }
     ...
     *
     * @param BackupGuardGoogle_TimelineItem $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_TimelineItem
     */
    public function insert(BackupGuardGoogle_TimelineItem $postBody, $optParams = array()) {
      $params = array('postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('insert', array($params));
      if ($this->useObjects()) {
     ...
     * @return BackupGuardGoogle_TimelineListResponse
     */
    public function listTimeline($optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_TimelineListResponse($data);
      } else {
        return $data;
      }
    }
     ...
     * @return BackupGuardGoogle_TimelineItem
     */
    public function patch($id, BackupGuardGoogle_TimelineItem $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('patch', array($params));
      if ($this->useObjects()) {
     ...
     * @return BackupGuardGoogle_TimelineItem
     */
    public function update($id, BackupGuardGoogle_TimelineItem $postBody, $optParams = array()) {
      $params = array('id' => $id, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
      $data = $this->__call('update', array($params));
      if ($this->useObjects()) {
   ...
   *  </code>
   */
  class BackupGuardGoogle_TimelineAttachmentsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     * @param string $attachmentId The ID of the attachment.
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Attachment
     */
    public function get($itemId, $attachmentId, $optParams = array()) {
      ...
      $data = $this->__call('get', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_Attachment($data);
      } else {
        return $data;
      }
    }
     ...
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_AttachmentsListResponse
     */
    public function listTimelineAttachments($itemId, $optParams = array()) {
      ...
      $data = $this->__call('list', array($params));
      if ($this->useObjects()) {
        return new BackupGuardGoogle_AttachmentsListResponse($data);
      } else {
        return $data;
      }
    }
...
/**
 * Service definition for BackupGuardGoogle_Mirror (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class BackupGuardGoogle_MirrorService extends BackupGuardGoogle_Service {
  public $contacts;
  public $locations;
...
class BackupGuardGoogle_Attachment extends BackupGuardGoogle_Model {
  public $contentType;
  public $contentUrl;
  public $id;
...
class BackupGuardGoogle_AttachmentsListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Attachment';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_Attachment) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Attachment', __METHOD__);
    $this->items = $items;
  }
...
class BackupGuardGoogle_Command extends BackupGuardGoogle_Model {
  public $type;
...
class BackupGuardGoogle_Contact extends BackupGuardGoogle_Model {
  protected $__acceptCommandsType = 'BackupGuardGoogle_Command';
  ...
  public $type;
  public function setAcceptCommands(/* array(BackupGuardGoogle_Command) */ $acceptCommands) {
    $this->assertIsArray($acceptCommands, 'BackupGuardGoogle_Command', __METHOD__);
    $this->acceptCommands = $acceptCommands;
  }
  public function getAcceptCommands() {
    return $this->acceptCommands;
  }
  public function setAcceptTypes(/* array(BackupGuardGoogle_string) */ $acceptTypes) {
    $this->assertIsArray($acceptTypes, 'BackupGuardGoogle_string', __METHOD__);
  ...
  public function setImageUrls(/* array(BackupGuardGoogle_string) */ $imageUrls) {
    $this->assertIsArray($imageUrls, 'BackupGuardGoogle_string', __METHOD__);
...
class BackupGuardGoogle_ContactsListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Contact';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_Contact) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Contact', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_Location extends BackupGuardGoogle_Model {
  public $accuracy;
  public $address;
  public $displayName;
  public $id;
...
class BackupGuardGoogle_LocationsListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Location';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_Location) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Location', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_MenuItem extends BackupGuardGoogle_Model {
  public $action;
  public $id;
  public $payload;
  public $removeWhenSelected;
  protected $__valuesType = 'BackupGuardGoogle_MenuValue';
  ...
  public function setValues(/* array(BackupGuardGoogle_MenuValue) */ $values) {
    $this->assertIsArray($values, 'BackupGuardGoogle_MenuValue', __METHOD__);
    $this->values = $values;
  }
...
class BackupGuardGoogle_MenuValue extends BackupGuardGoogle_Model {
  public $displayName;
  public $iconUrl;
  public $state;
  public function setDisplayName( $displayName) {
...
class BackupGuardGoogle_Notification extends BackupGuardGoogle_Model {
  public $collection;
  public $itemId;
  public $operation;
  protected $__userActionsType = 'BackupGuardGoogle_UserAction';
  ...
  public function setUserActions(/* array(BackupGuardGoogle_UserAction) */ $userActions) {
    $this->assertIsArray($userActions, 'BackupGuardGoogle_UserAction', __METHOD__);
...
class BackupGuardGoogle_NotificationConfig extends BackupGuardGoogle_Model {
  public $deliveryTime;
  public $level;
...
class BackupGuardGoogle_Subscription extends BackupGuardGoogle_Model {
  ...
  public $id;
  public $kind;
  protected $__notificationType = 'BackupGuardGoogle_Notification';
  ...
  public function setNotification(BackupGuardGoogle_Notification $notification) {
    $this->notification = $notification;
  }
  public function getNotification() {
    return $this->notification;
  }
  public function setOperation(/* array(BackupGuardGoogle_string) */ $operation) {
    $this->assertIsArray($operation, 'BackupGuardGoogle_string', __METHOD__);
    $this->operation = $operation;
  }
  public function getOperation() {
    return $this->operation;
...
class BackupGuardGoogle_SubscriptionsListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_Subscription';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public function setItems(/* array(BackupGuardGoogle_Subscription) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_Subscription', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_TimelineItem extends BackupGuardGoogle_Model {
  protected $__attachmentsType = 'BackupGuardGoogle_Attachment';
  protected $__attachmentsDataType = 'array';
  public $attachments;
  public $bundleId;
  public $canonicalUrl;
  public $created;
  protected $__creatorType = 'BackupGuardGoogle_Contact';
  ...
  public $isPinned;
  public $kind;
  protected $__locationType = 'BackupGuardGoogle_Location';
  protected $__locationDataType = '';
  public $location;
  protected $__menuItemsType = 'BackupGuardGoogle_MenuItem';
  protected $__menuItemsDataType = 'array';
  public $menuItems;
  protected $__notificationType = 'BackupGuardGoogle_NotificationConfig';
  protected $__notificationDataType = '';
  public $notification;
  public $pinScore;
  protected $__recipientsType = 'BackupGuardGoogle_Contact';
  ...
  public $title;
  public $updated;
  public function setAttachments(/* array(BackupGuardGoogle_Attachment) */ $attachments) {
    $this->assertIsArray($attachments, 'BackupGuardGoogle_Attachment', __METHOD__);
  ...
  public function setCreator(BackupGuardGoogle_Contact $creator) {
  ...
  public function setHtmlPages(/* array(BackupGuardGoogle_string) */ $htmlPages) {
    $this->assertIsArray($htmlPages, 'BackupGuardGoogle_string', __METHOD__);
  ...
  public function setLocation(BackupGuardGoogle_Location $location) {
    $this->location = $location;
  }
  public function getLocation() {
    return $this->location;
  }
  public function setMenuItems(/* array(BackupGuardGoogle_MenuItem) */ $menuItems) {
    $this->assertIsArray($menuItems, 'BackupGuardGoogle_MenuItem', __METHOD__);
    $this->menuItems = $menuItems;
  }
  public function getMenuItems() {
    return $this->menuItems;
  }
  public function setNotification(BackupGuardGoogle_NotificationConfig $notification) {
    $this->notification = $notification;
  }
  public function getNotification() {
    return $this->notification;
  ...
  public function setRecipients(/* array(BackupGuardGoogle_Contact) */ $recipients) {
    $this->assertIsArray($recipients, 'BackupGuardGoogle_Contact', __METHOD__);
...
class BackupGuardGoogle_TimelineListResponse extends BackupGuardGoogle_Model {
  protected $__itemsType = 'BackupGuardGoogle_TimelineItem';
  protected $__itemsDataType = 'array';
  public $items;
  public $kind;
  public $nextPageToken;
  public function setItems(/* array(BackupGuardGoogle_TimelineItem) */ $items) {
    $this->assertIsArray($items, 'BackupGuardGoogle_TimelineItem', __METHOD__);
    $this->items = $items;
  }
  public function getItems() {
    return $this->items;
...
class BackupGuardGoogle_UserAction extends BackupGuardGoogle_Model {
  public $payload;
  public $type;
  public function setPayload( $payload) {
    $this->payload = $payload;
