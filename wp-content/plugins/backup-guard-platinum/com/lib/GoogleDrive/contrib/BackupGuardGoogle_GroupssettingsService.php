 ...
 */
   ...
   * Typical usage is:
   *  <code>
   *   $groupssettingsService = new BackupGuardGoogle_GroupssettingsService(...);
  ...
  class BackupGuardGoogle_GroupsServiceResource extends BackupGuardGoogle_ServiceResource {
     ...
     *
     * @param string $groupUniqueId The resource ID
     * @param BackupGuardGoogle_Groups $postBody
     * @param array $optParams Optional parameters.
     * @return BackupGuardGoogle_Groups
     */
    public function patch($groupUniqueId, BackupGuardGoogle_Groups $postBody, $optParams = array()) {
     ...
     * @return BackupGuardGoogle_Groups
     */
    public function update($groupUniqueId, BackupGuardGoogle_Groups $postBody, $optParams = array()) {
      $params = array('groupUniqueId' => $groupUniqueId, 'postBody' => $postBody);
      $params = array_merge($params, $optParams);
...
/**
 * Service definition for BackupGuardGoogle_Groupssettings (v1).
 *
 * <p>
 ...
 * @author Google, Inc.
 */
class BackupGuardGoogle_GroupssettingsService extends BackupGuardGoogle_Service {
  public $groups;
  /**
