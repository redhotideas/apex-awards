 ...
 */
class BackupGuardGoogle_REST // phpcs:ignore
{
    /**
     ...
     *
     * @param BackupGuardGoogle_HttpRequest $req
     * @return array decoded result
     * @throws BackupGuardGoogle_ServiceException on server side error (ie: not authenticated,
     *  invalid or malformed post body, invalid url)
     */
    public static function execute(BackupGuardGoogle_HttpRequest $req)
    {
        $httpRequest = BackupGuardGoogle_Client::$io->makeRequest($req);
     ...
     * @static
     * @param BackupGuardGoogle_HttpRequest $response The http response to be decoded.
     * @return mixed|null
     * @throws BackupGuardGoogle_ServiceException
     */
    public static function decodeHttpResponse($response)
    {
        ...
        if ((intVal($code)) >= 300) {
            ...
            throw new BackupGuardGoogle_ServiceException($err, $code, null, $decoded['error']['errors']);
        }
        ...
        if ($code != '204') {
            ...
            if ($decoded === null || $decoded === "") {
                throw new BackupGuardGoogle_ServiceException("Invalid json in service response: $body");
            }
        }
        return $decoded;
    }
