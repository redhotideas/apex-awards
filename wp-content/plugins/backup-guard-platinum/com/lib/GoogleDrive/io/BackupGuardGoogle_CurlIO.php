...
class BackupGuardGoogle_CurlIO extends BackupGuardGoogle_IO {
   ...
   * @return BackupGuardGoogle_HttpRequest http request with the response http code, response
  ...
  public function makeRequest(BackupGuardGoogle_HttpRequest $request) {
    ...
    if ($curlErrorNum != CURLE_OK) {
      throw new BackupGuardGoogle_IOException("HTTP Error: ($respHttpCode) $curlError");
    }
