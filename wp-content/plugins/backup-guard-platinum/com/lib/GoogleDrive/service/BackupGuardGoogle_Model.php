...
class BackupGuardGoogle_Model {
   ...
   * @throws BackupGuardGoogle_Exception Thrown if $obj isn't an array.
  ...
  public function assertIsArray($obj, $type, $method) {
    if ($obj && !is_array($obj)) {
      throw new BackupGuardGoogle_Exception("Incorrect parameter type passed to $method(), expected an"
