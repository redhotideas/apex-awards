...
namespace BackupGuard\Guzzle\Service;

use BackupGuard\Guzzle\Common\Collection;
use BackupGuard\Guzzle\Common\Exception\InvalidArgumentException;
use BackupGuard\Guzzle\Common\Exception\BadMethodCallException;
use BackupGuard\Guzzle\Common\Version;
use BackupGuard\Guzzle\Inflection\InflectorInterface;
use BackupGuard\Guzzle\Inflection\Inflector;
use BackupGuard\Guzzle\Http\Client as HttpClient;
use BackupGuard\Guzzle\Http\Exception\MultiTransferException;
use BackupGuard\Guzzle\Service\Exception\CommandTransferException;
...
use BackupGuard\Guzzle\Service\Command\Factory\FactoryInterface as CommandFactoryInterface;
use BackupGuard\Guzzle\Service\Resource\ResourceIteratorClassFactory;
use BackupGuard\Guzzle\Service\Resource\ResourceIteratorFactoryInterface;
