...
namespace BackupGuard\Guzzle\Batch;

use BackupGuard\Guzzle\Batch\BatchTransferInterface;
use BackupGuard\Guzzle\Batch\BatchDivisorInterface;
    ...
    public function createBatches(\SplQueue $queue)
    {
        ...
        foreach ($queue as $item) {
            if (!$item instanceof RequestInterface) {
                throw new InvalidArgumentException('All items must implement BackupGuard\Guzzle\Http\Message\RequestInterface');
            }
