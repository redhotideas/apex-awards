...
use BackupGuard\Guzzle\Http\Message\EntityEnclosingRequestInterface;
use BackupGuard\Guzzle\Http\Exception\TooManyRedirectsException;
use BackupGuard\Guzzle\Http\Exception\CouldNotRewindStreamException;
