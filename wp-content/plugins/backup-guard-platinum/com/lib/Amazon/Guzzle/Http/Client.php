...
namespace BackupGuard\Guzzle\Http;

use BackupGuard\Guzzle\Common\Collection;
use BackupGuard\Guzzle\Common\AbstractHasDispatcher;
use BackupGuard\Guzzle\Common\Exception\ExceptionCollection;
...
use BackupGuard\Guzzle\Parser\UriTemplate\UriTemplateInterface;
use BackupGuard\Guzzle\Http\Message\RequestInterface;
use BackupGuard\Guzzle\Http\Message\RequestFactory;
use BackupGuard\Guzzle\Http\Message\RequestFactoryInterface;
use BackupGuard\Guzzle\Http\Curl\CurlMultiInterface;
use BackupGuard\Guzzle\Http\Curl\CurlMultiProxy;
use BackupGuard\Guzzle\Http\Curl\CurlHandle;
use BackupGuard\Guzzle\Http\Curl\CurlVersion;
