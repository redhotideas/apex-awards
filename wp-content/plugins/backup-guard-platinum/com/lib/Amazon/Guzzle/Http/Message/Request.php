...
namespace BackupGuard\Guzzle\Http\Message;

use BackupGuard\Guzzle\Common\Version;
use BackupGuard\Guzzle\Common\Event;
...
use BackupGuard\Guzzle\Http\Exception\RequestException;
use BackupGuard\Guzzle\Http\Exception\BadResponseException;
use BackupGuard\Guzzle\Http\ClientInterface;
use BackupGuard\Guzzle\Http\EntityBody;
use BackupGuard\Guzzle\Http\EntityBodyInterface;
use BackupGuard\Guzzle\Http\Message\Header\HeaderInterface;
use BackupGuard\Guzzle\Http\Url;
use BackupGuard\Guzzle\Parser\ParserRegistry;
...
class Request extends AbstractMessage implements RequestInterface
{
    ...
    /**
     * @deprecated use BackupGuard\Guzzle\Plugin\Cache\DefaultCanCacheStrategy
     * @codeCoverageIgnore
     */
    public function canCache()
    {
        Version::warn(__METHOD__ . ' is deprecated. use BackupGuard\Guzzle\Plugin\Cache\DefaultCanCacheStrategy.');
        if (class_exists('BackupGuard\Guzzle\Plugin\Cache\DefaultCanCacheStrategy')) {
            $canCache = new \BackupGuard\Guzzle\Plugin\Cache\DefaultCanCacheStrategy();
