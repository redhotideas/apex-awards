...
namespace BackupGuard\Aws\S3;

use BackupGuard\Aws\Common\Client\AbstractClient;
use BackupGuard\Aws\Common\Client\ClientBuilder;
use BackupGuard\Aws\Common\Client\ExpiredCredentialsChecker;
use BackupGuard\Aws\Common\Client\UploadBodyListener;
use BackupGuard\Aws\Common\Enum\ClientOptions as Options;
use BackupGuard\Aws\Common\Exception\RuntimeException;
use BackupGuard\Aws\Common\Exception\InvalidArgumentException;
use BackupGuard\Aws\Common\Signature\SignatureV4;
use BackupGuard\Aws\Common\Model\MultipartUpload\AbstractTransfer;
use BackupGuard\Aws\S3\Exception\AccessDeniedException;
use BackupGuard\Aws\S3\Exception\Parser\S3ExceptionParser;
use BackupGuard\Aws\S3\Exception\S3Exception;
use BackupGuard\Aws\S3\Model\ClearBucket;
use BackupGuard\Aws\S3\Model\MultipartUpload\AbstractTransfer as AbstractMulti;
use BackupGuard\Aws\S3\Model\MultipartUpload\UploadBuilder;
use BackupGuard\Aws\S3\Sync\DownloadSyncBuilder;
use BackupGuard\Aws\S3\Sync\UploadSyncBuilder;
use BackupGuard\Guzzle\Common\Collection;
use BackupGuard\Guzzle\Http\EntityBody;
use BackupGuard\Guzzle\Http\Message\RequestInterface;
use BackupGuard\Guzzle\Iterator\FilterIterator;
...
use BackupGuard\Guzzle\Service\Command\Factory\AliasFactory;
use BackupGuard\Guzzle\Service\Command\Factory\CompositeFactory;
use BackupGuard\Guzzle\Service\Resource\Model;
use BackupGuard\Guzzle\Service\Resource\ResourceIteratorInterface;
...
class S3Client extends AbstractClient
{
    ...
    public static function factory($config = array())
    {
        ...
        $default->add(
            ...
            'BackupGuard\Guzzle\Service\Command\Factory\ServiceDescriptionFactory'
        );
