...
use BackupGuard\Aws\S3\Exception\NoSuchKeyException;
use BackupGuard\Aws\S3\Iterator\ListObjectsIterator;
use BackupGuard\Guzzle\Http\EntityBody;
use BackupGuard\Guzzle\Http\CachingEntityBody;
use BackupGuard\Guzzle\Http\Mimetypes;
use BackupGuard\Guzzle\Iterator\FilterIterator;
use BackupGuard\Guzzle\Stream\PhpStreamRequestFactory;
...
class StreamWrapper
{
    ...
    protected function openReadStream(array $params, array &$errors)
    {
        ...
        $this->body = $factory->fromRequest($request, array(), array('stream_class' => 'BackupGuard\Guzzle\Http\EntityBody'));
