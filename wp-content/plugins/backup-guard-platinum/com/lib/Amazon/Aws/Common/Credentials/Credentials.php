...
namespace BackupGuard\Aws\Common\Credentials;

use BackupGuard\Aws\Common\Enum\ClientOptions as Options;
use BackupGuard\Aws\Common\Exception\InvalidArgumentException;
use BackupGuard\Aws\Common\Exception\RequiredExtensionNotLoadedException;
use BackupGuard\Aws\Common\Exception\RuntimeException;
use BackupGuard\Guzzle\Common\FromConfigInterface;
use BackupGuard\Guzzle\Cache\CacheAdapterInterface;
use BackupGuard\Guzzle\Cache\DoctrineCacheAdapter;
        ...
        if ($cache === 'true' || $cache === true) {
            ...
            if (!extension_loaded('apc')) {
                ...
                throw new RuntimeException(
                    ...
                    . 'BackupGuard\Guzzle\Cache\CacheAdapterInterface object'
                );
            }
