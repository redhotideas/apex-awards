...
namespace BackupGuard\Aws\Common\Signature;

use BackupGuard\Aws\Common\Credentials\CredentialsInterface;
use BackupGuard\Aws\Common\Enum\DateFormat;
use BackupGuard\Aws\Common\HostNameUtils;
...
use BackupGuard\Guzzle\Stream\Stream;
