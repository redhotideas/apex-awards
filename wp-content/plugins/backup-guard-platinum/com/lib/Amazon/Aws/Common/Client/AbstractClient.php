...
use BackupGuard\Aws\Common\Aws;
...
use BackupGuard\Aws\Common\Exception\TransferException;
...
use BackupGuard\Aws\Common\Signature\SignatureListener;
use BackupGuard\Aws\Common\Waiter\WaiterClassFactory;
use BackupGuard\Aws\Common\Waiter\CompositeWaiterFactory;
use BackupGuard\Aws\Common\Waiter\WaiterFactoryInterface;
use BackupGuard\Aws\Common\Waiter\WaiterConfigFactory;
use BackupGuard\Guzzle\Common\Collection;
use BackupGuard\Guzzle\Http\Exception\CurlException;
use BackupGuard\Guzzle\Http\QueryAggregator\DuplicateAggregator;
use BackupGuard\Guzzle\Service\Client;
use BackupGuard\Guzzle\Service\Description\ServiceDescriptionInterface;
