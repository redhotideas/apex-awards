...
namespace BackupGuard\Symfony\Component\EventDispatcher\Tests\DependencyInjection;

use BackupGuard\Symfony\Component\DependencyInjection\ContainerBuilder;
use BackupGuard\Symfony\Component\EventDispatcher\DependencyInjection\RegisterListenersPass;
...
class RegisterListenersPassTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testEventSubscriberWithoutInterface()
    {
        ...
        $definition = $this->getMock('BackupGuard\Symfony\Component\DependencyInjection\Definition');
        ...
        $builder = $this->getMock(
            'BackupGuard\Symfony\Component\DependencyInjection\ContainerBuilder',
    ...
    public function testValidEventSubscriber()
    {
        ...
        $definition->expects($this->atLeastOnce())
            ->method('getClass')
            ->will($this->returnValue('BackupGuard\Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService'));
    ...
    public function testEventSubscriberResolvableClassName()
    {
        ...
        $container->setParameter('subscriber.class', 'BackupGuard\Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService');
        ...
        $expected_calls = array(
            array(
                ...
                array(
                    'foo',
                    'BackupGuard\Symfony\Component\EventDispatcher\Tests\DependencyInjection\SubscriberService',
                ),
            ),
        );
...
class SubscriberService implements \BackupGuard\Symfony\Component\EventDispatcher\EventSubscriberInterface
{
