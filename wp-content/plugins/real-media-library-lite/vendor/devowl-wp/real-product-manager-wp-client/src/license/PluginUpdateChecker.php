...
class PluginUpdateChecker {
    ...
    public function probablyEnableExternalUpdates() {
        ...
        $puc = \MatthiasWeb\RealMediaLibrary\Vendor\Puc_v4_Factory::buildUpdateChecker(
    ...
    public static function instance($pluginUpdate) {
        return new \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\license\PluginUpdateChecker(
            $pluginUpdate
        );
    }
}
