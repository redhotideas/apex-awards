...
class Core {
    ...
    private function __construct() {
        $this->assets = \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Assets::instance();
        ...
        add_action('rest_api_init', [
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\rest\PluginUpdate::instance(),
            'rest_api_init'
        ]);
        add_action('rest_api_init', [
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\rest\Announcement::instance(),
            'rest_api_init'
        ]);
        add_action('rest_api_init', [
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\rest\Feedback::instance(),
            'rest_api_init'
        ]);
    }
    /**
    ...
    public static function getInstance() {
        return !isset(self::$me)
            ? (self::$me = new \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Core())
            : self::$me;
    }
}
