...
class Assets {
    ...
    public function overrideLocalizeScript($context) {
        ...
        $names = [];
        foreach (
            \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Core::getInstance()->getInitiators()
            as $initiator
        ) {
        ...
        return [
            'currentUserFullName' => \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Utils::getUserFullName(),
            'names' => $names
        ];
    }
    /**
    ...
    public static function instance() {
        return new \MatthiasWeb\RealMediaLibrary\Vendor\DevOwl\RealProductManagerWpClient\Assets();
    }
}
