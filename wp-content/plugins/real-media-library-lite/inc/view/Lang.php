...
You can also order the images into *a custom image order* per drag&drop.',
            ...
            'licenseIsDev' => __('Product license not for production use!', RML_TD),
            'licenseFreeDescription' => __(
                'Before we start organizing your media, you can *obtain your free license to enjoy all the benefits* of the free version of Real Media Library. Get started now!',
                RML_TD
            ),
            'licenseActivation' => __('License activation', RML_TD),
            'licenseGetFreeActivation' => __('Get your free license', RML_TD),
            'licenseActivationBtnPro' => __('Activate license & continue', RML_TD),
            'licenseActivationBtnFree' => __('Activate free license & Continue', RML_TD),
            'licenseActivationSkipPro' => __('Continue without regular updates and without any support', RML_TD),
            'licenseActivationSkipFree' => __(
            ...
            'proDismiss' => __('Hide for 30 days', RML_TD),
